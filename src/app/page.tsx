...
export default async function Home() {
  ...
  return (
    <div className="h-screen flex-col w-full dark:bg-black bg-white  dark:bg-grid-white/5 bg-grid-black/5 relative flex items-center justify-center">
      ...
      <h1 className="text-2xl md:text-4xl font-bold relative z-20 bg-clip-text text-transparent bg-gradient-to-b text-center dark:from-neutral-200 from-neutral-500 dark:to-neutral-500 to-neutral-700 pb-4">
        Ladeva Dashboard CMS
      </h1>
      <p className="text-xs md:text-sm max-w-5xl mx-auto text-center font-normal relative z-20 bg-clip-text text-transparent dark:bg-neutral-400 bg-neutral-600">
